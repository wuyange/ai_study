...
function WeekPanel(props) {
  ...
  var rowClassName = function rowClassName(date) {
    ...
    return (0, _classnames.default)(rowPrefixCls, (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(rowPrefixCls, "-selected"), !rangedValue && (0, _dateUtil.isSameWeek)(generateConfig, locale.locale, value, date)), "".concat(rowPrefixCls, "-range-start"), isRangeStart), "".concat(rowPrefixCls, "-range-end"), isRangeEnd), "".concat(rowPrefixCls, "-range-hover"), !isRangeStart && !isRangeEnd && (0, _dateUtil.isInRange)(generateConfig, rangeStart, rangeEnd, date)));
  };
