...
function DecadeBody(props) {
  ...
  var getCellClassName = function getCellClassName(date) {
    ...
    return (0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(cellPrefixCls, "-in-view"), startDecadeYear <= startDecadeNumber && endDecadeNumber <= endDecadeYear), "".concat(cellPrefixCls, "-selected"), startDecadeNumber === decadeYearNumber);
  };
