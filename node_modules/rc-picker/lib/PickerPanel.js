...
function PickerPanel(props) {
  ...
  return /*#__PURE__*/React.createElement(_PanelContext.default.Provider, {
    ...
    tabIndex: tabIndex,
    className: (0, _classnames.default)("".concat(prefixCls, "-panel"), className, (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(prefixCls, "-panel-has-range"), rangedValue && rangedValue[0] && rangedValue[1]), "".concat(prefixCls, "-panel-has-range-hover"), hoverRangedValue && hoverRangedValue[0] && hoverRangedValue[1]), "".concat(prefixCls, "-panel-rtl"), direction === 'rtl')),
    style: style,
    onKeyDown: onInternalKeyDown,
