...
function InnerRangePicker(props) {
  ...
  return /*#__PURE__*/React.createElement(_PanelContext.default.Provider, {
    ...
    ref: containerRef,
    className: (0, _classnames.default)(prefixCls, "".concat(prefixCls, "-range"), className, (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(prefixCls, "-disabled"), mergedDisabled[0] && mergedDisabled[1]), "".concat(prefixCls, "-focused"), mergedActivePickerIndex === 0 ? startFocused : endFocused), "".concat(prefixCls, "-rtl"), direction === 'rtl')),
    style: style,
    ...
    className: (0, _classnames.default)("".concat(prefixCls, "-input"), (0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(prefixCls, "-input-active"), mergedActivePickerIndex === 0), "".concat(prefixCls, "-input-placeholder"), !!startHoverValue)),
    ...
    className: (0, _classnames.default)("".concat(prefixCls, "-input"), (0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(prefixCls, "-input-active"), mergedActivePickerIndex === 1), "".concat(prefixCls, "-input-placeholder"), !!endHoverValue)),
    ref: endInputDivRef
  }, /*#__PURE__*/React.createElement("input", (0, _extends2.default)({
